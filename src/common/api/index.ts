...
const requestALi = (url: string, init: { data: any, headers: any, method: string }) => {
  return request({
    url: base + url,
...
export { requestALi as request, getAudioManager, StorageSync, getMenuButtonBoundingClientRect, getSystemInfoSync }